# Generated by Django 3.2 on 2022-02-27 11:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='SEK', max_digits=14)),
                ('description', models.TextField()),
                ('requisite', models.TextField()),
                ('picture_url', models.TextField(validators=[django.core.validators.URLValidator()])),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_spotless_app.service')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
